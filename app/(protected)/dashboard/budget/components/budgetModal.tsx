                ...
                <motion.div
                    ...
                    <motion.div
                        ...
                        <div className="w-full relative flex justify-center items-center">
                            ...
                            <input value={budget?.amount ?? ""} onChange={(e) => setBudget(prev => prev ? { ...prev, amount: Number(e.target.value) } : prev)} placeholder="0.00" className="border-[#715767] w-full flex justify-center items-center py-1 rounded-full text-center border-4 text-[#715767] text-7xl font-bold" />
                        </div>
