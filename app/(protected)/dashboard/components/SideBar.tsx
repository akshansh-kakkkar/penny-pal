...
export default function SideBar({ openModal }: sideBarProps) {
  ...
  return (
    <div className="bg-[#FFFFFF] h-screen fixed hidden lg:flex flex-col justify-between py-16 px-4  shadow-[0px_20px_40px_rgba(113,87,103,0.1)] shadow-lg shadow-[0px_10px_20px_rgba(244,210,229,0.2)] rounded-r-3xl w-[400px]">
      <div className="flex flex-col gap-10">
        <div className="flex gap-6 flex-col">
          ...
          <div className="flex text-center items-center justify-center gap-4">
            <div className="flex text-xl justify-center items-center text-center border-[#F4D2E5] border-5 rounded-full w-14 h-14 font-bold text-white bg-[#715767]">{session?.user.name.charAt(0).toUpperCase()}</div>
