...
export default function SideBar() {
  ...
  return (
    <div className="bg-[#FFFFFF] flex flex-col justify-between py-16 px-4  shadow-[0px_20px_40px_rgba(113,87,103,0.1)] shadow-lg shadow-[0px_10px_20px_rgba(244,210,229,0.2)] rounded-r-3xl w-[400px]">
