...
export default function Navbar() {
  ...
  return (
    <>
      <div
        className={`sticky z-50   text-[#715767] bg-[#FAF9F6] flex items-center text-center justify-between ${scrolled ? "px-5 lg:px-12 xl:px-24 py-3 mx-4 mt-12 rounded-full shadow-lg top-4" : "px-5 top-0 lg:px-20 xl:px-40 py-6"}`}
      >
        ...
        <div className="hidden md:flex gap-4 text-sm font-bold items-center text-center justify-center">
          {session ? (
            <div className="text-2xl bg-[#715767] text-white rounded-full w-12 h-12 flex text-center items-center justify-center">
            ...
            <>
              <button
                ...
                className="bg-[#715767] px-6 py-2 border-2 cursor-pointer transition-all hover:scale-[105%] hover:bg-[#826476] duration-300 border-[#715767] text-white rounded-full"
              >
                Sign In
              </button>
              <button
